...
class Pengalaman extends CI_Controller
{
    ...
    {
        if (!isset($id)) redirect('admin/pengalaman/edit_pengalaman');
        ...
        if ($validation->run()) {
            ...
            redirect(site_url('admin/pengalaman/edit_pengalaman'));
        ...
        $this->load->view("admin/pengalaman/edit_pengalaman", $data);
    }
